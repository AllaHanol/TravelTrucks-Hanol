...
import { getCamperInfo } from '../../redux/trucks/trucksOperations.js';
        ...
        Object.keys(truckInfo).length !== 0 && (
          <div className={css.container}>
            ...
            <div className={css.navigation}>
              <button
                className={`${css.btn} ${features && css.isActive}`}
                onClick={() => handleClick('features')}
              >
                <h3>Features</h3>
              </button>
              <button
                className={`${css.btn} ${reviews && css.isActive}`}
                onClick={() => handleClick('reviews')}
              >
                <h3>Reviews</h3>
              </button>
            </div>
            <div className={css.detail_info_form}>
              {features ? (
